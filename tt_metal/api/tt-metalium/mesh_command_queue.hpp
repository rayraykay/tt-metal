...
private:
    ...
    std::unordered_map<IDevice*, MultiProducerSingleConsumerQueue<CompletionReaderVariant>> read_descriptors_;
    ...
    // Mutex to guard the read_descriptors_ queue
    std::mutex read_descriptors_mutex_;
