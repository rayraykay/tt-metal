...
constexpr uint32_t FABRIC_ROUTER_SYNC_SEM = FABRIC_ROUTER_MISC_START + FABRIC_ROUTER_SYNC_SEM_OFFSET;
static_assert(FABRIC_ROUTER_SYNC_SEM == eth_l1_mem::address_map::ERISC_L1_UNRESERVED_BASE);
constexpr uint32_t FABRIC_ROUTER_STATUS_PTR = FABRIC_ROUTER_MISC_START + FABRIC_ROUTER_STATUS_PTR_OFFSET;
constexpr uint32_t FABRIC_ROUTER_HOST_SIGNAL_PTR = FABRIC_ROUTER_MISC_START + FABRIC_ROUTER_HOST_SIGNAL_PTR_OFFSET;
