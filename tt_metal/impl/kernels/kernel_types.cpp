...
ReaderDataMovementConfig::ReaderDataMovementConfig(
    ...
    DataMovementConfig{
        ...
        .noc = detail::GetPreferredNOCForDRAMRead(tt::tt_metal::MetalContext::get_cluster().arch()),
...
WriterDataMovementConfig::WriterDataMovementConfig(
    ...
    DataMovementConfig{
        ...
        .noc = detail::GetPreferredNOCForDRAMWrite(tt::tt_metal::MetalContext::get_cluster().arch()),
        .noc_mode = NOC_MODE::DM_DEDICATED_NOC,
        .compile_args = std::move(compile_args),
        .defines = std::move(defines),
        .opt_level = opt_level} {}
