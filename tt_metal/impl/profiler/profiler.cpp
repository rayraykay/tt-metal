...
void DeviceProfiler::readRiscProfilerResults(
    ...
    if (tt::tt_metal::MetalContext::get_cluster().is_worker_core(worker_core, device_id)) {
        ...
        bool is_active_eth_core =
            active_eth_cores.find(tt::tt_metal::MetalContext::get_cluster().get_logical_ethernet_core_from_virtual(
    ...
    uint32_t coreFlatID =
        tt::tt_metal::MetalContext::get_cluster().get_virtual_routing_to_profiler_flat_id(device_id).at(worker_core);
...
void DeviceProfiler::dumpResults(
    ...
    device_core_frequency = tt::tt_metal::MetalContext::get_cluster().get_device_aiclk(device_id);
