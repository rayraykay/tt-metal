...
uint32_t GeneratePerDeviceProgramID(uint32_t base_program_id, uint32_t device_id, bool is_host_fallback_op) {
...
#if defined(TRACY_ENABLE)
    static constexpr uint32_t DEVICE_ID_NUM_BITS = 10;
    static constexpr uint32_t DEVICE_OP_ID_NUM_BITS = 31;
