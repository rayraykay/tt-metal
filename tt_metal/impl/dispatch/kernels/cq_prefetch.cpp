...
uint32_t process_paged_to_ringbuffer_cmd(uint32_t cmd_ptr, uint32_t& downstream__data_ptr) {
    ...
    if (flags & CQ_PREFETCH_PAGED_TO_RING_BUFFER_RESET_TO_START) {
    ...
    InterleavedPow2AddrGen<true> addr_gen{.bank_base_address = base_addr, .log_base_2_of_page_size = log2_page_size};
