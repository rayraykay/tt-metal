...
constexpr uint32_t outbound_eth_chan = get_compile_time_arg_val(33);
...
void kernel_main_d() {
    ...
    while (!done) {
        ...
        tt::tt_fabric::fabric_client_connect(client_interface, 0, upstream_mesh_id, upstream_dev_id);
        relay_cb_release_pages<
            is_h_variant,
            is_d_variant,
            upstream_mesh_id,
