...
public:
    PrefetchKernel(
        ...
        auto& core_manager = tt::tt_metal::MetalContext::get_dispatch_core_manager();  // Not thread safe
        ...
        if (h_variant && d_variant) {
            ...
            channel = tt::tt_metal::MetalContext::get_cluster().get_assigned_channel_for_device(servicing_device_id);
