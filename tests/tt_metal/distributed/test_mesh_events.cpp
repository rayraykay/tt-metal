...
//     std::vector<std::shared_ptr<MeshEvent>> write_events;
//     std::vector<std::shared_ptr<MeshEvent>> read_events;
...
//         write_events.push_back(std::make_shared<MeshEvent>());
//         EnqueueRecordEventToHost(write_cq, write_events.back());
...
//         read_events.push_back(std::make_shared<MeshEvent>());
//         EnqueueRecordEventToHost(read_cq, read_events.back());
//     }
