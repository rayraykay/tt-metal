...
struct CumprodDeviceOperation {
    ...
    struct SingleCoreCumprodProgramFactory {
        ...
        enum class CumprodCB : std::underlying_type_t<tt::CBIndex> { SRC, ACC, DST, NUM_CBS };

        static constexpr std::array<const char*, static_cast<uint32_t>(CumprodCB::NUM_CBS)> KERNEL_PATHS{
