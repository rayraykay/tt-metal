...
class Conv2dDynamicSamePadding:
    ...
    def __call__(self, x):
        if self.pad_h > 0 or self.pad_w > 0:
            ...
            # torch.save(x,"models/experimental/functional_mobilenetv2/dumps/padtt")
...
class MBConvBlock:
    def __init__(
        ...
        # self._avg_pooling = ttnn.global_avg_pool2d()
    ...
    def __call__(self, x):
        ...
        #     "models/experimental/functional_mobilenetv2/dumps/depthwise_tt",
        # )
        if x.is_sharded() or self.is_width_sharded:
...
class Efficientnetb0:
    ...
    def __call__(self, x):
        ...
        #     x,
        #     self.batch,
        #     self.conv_params._conv_head.out_channels,
